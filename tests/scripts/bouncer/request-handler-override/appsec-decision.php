...
if (!$apiKey || !$appSecMethod || !$appSecUrl) {
    exit('Params <BOUNCER_KEY> and </BOUNCER_KEY><APPSEC_METHOD> and <APPSEC_URL> are required' . \PHP_EOL
         . 'Usage: php appsec-decisions.php <BOUNCER_KEY> <HEADERS_JSON> <APPSEC_METHOD> <APPSEC_URL> [<RAW_BODY_STRING>]'
         . \PHP_EOL
